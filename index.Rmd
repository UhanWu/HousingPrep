...
ggplot(mapping=aes(x = DATE,y=Data,color=City,group=1, text = paste("Date:",DATE, "\n")))+
  ...
  labs(title="Housing Price fluctuation between 1984 and 2021 of three Cities",x="Time (1987-2021)",y="Case-Shiller index")

   ggplotly(data_plotly, tooltip = "text")
     
```

"San Francisco endured the greatest decline in year 2008"