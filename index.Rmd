...
ggplot(mapping=aes(x = DATE,y=Data,color=City,group=1, text = paste("Date:",DATE, "\n")))+
  ...
  labs(title="Housing Price Fluctuation of Three Cities",x="Time (1987-2021)",y="Case-Shiller index")
...
#Analysis#
San Francisco endured the greatest decline in 2008 Housing bubble, and generally for all three cities housing price shows an upward sloping trend,which means that the value of an single-familly house keep increasing over time. 