...
clean_Income_data <-bind_rows(Income_MA,Income_NY,Income_CA)
```
...
ggplot(mapping=aes(x = DATE,y=Data_Income,color=States,group=1, text = paste("Date:",DATE, "\n")))+
  geom_line()+
  scale_x_discrete(breaks=12)+
  labs(title="Real Median Household Income Of Three Cities",x="Time (1984-2020)",y="US Adjusted Dollar")
